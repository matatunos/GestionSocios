...
<div class="mb-6">
    <a href="index.php?page=book_activities&year=<?php echo $year; ?>" class="btn btn-sm btn-secondary mb-4">
        <i class="fas fa-arrow-left"></i> Volver al listado
    </a>
    <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Nueva Actividad <?php echo $year; ?></h1>
</div>
