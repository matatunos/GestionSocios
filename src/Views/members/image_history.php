    ...
    <div class="flex justify-between items-center mb-4">
        <div class="history-header">
            ...
            <p style="color: var(--text-muted); margin-top: 0.5rem;">
                Socio: <strong><?php echo htmlspecialchars($member->first_name . ' ' . $member->last_name); ?></strong>
            </p>
        </div>
        <a href="index.php?page=members&action=edit&id=<?php echo $member->id; ?>" class="btn btn-secondary">
    ...
    <?php if (empty($images)): ?>
        <div class="card">
            <div class="empty-state">
                ...
                <p>Este socio aún no tiene imágenes en el histórico.</p>
            </div>
        </div>
    <?php else: ?>
                ...
                <div class="history-card <?php echo $image['is_current'] ? 'current' : ''; ?>">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-actions">
                            ...
                            <?php else: ?>
                                <form method="POST" 
                                      action="index.php?page=members&action=restoreImage&id=<?php echo $member->id; ?>&historyId=<?php echo $image['id']; ?>" 
                                      style="flex: 1;"
